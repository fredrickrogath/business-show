import 'package:adela/models/nguo.dart';
import 'package:adela/tabs/bidhaa_tab/button/uza.dart';
import 'package:animated_text_kit/animated_text_kit.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';

class NguoParallax extends StatefulWidget {
  const NguoParallax({
    Key? key,
  }) : super(key: key);

  @override
  State<NguoParallax> createState() => _NguoParallaxState();
}

class _NguoParallaxState extends State<NguoParallax>
